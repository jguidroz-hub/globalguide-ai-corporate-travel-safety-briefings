...
const FROM = process.env.EMAIL_FROM || 'GlobalGuide AI - Corporate Travel Safety Briefings <noreply@example.com>';
const APP_NAME = 'GlobalGuide AI - Corporate Travel Safety Briefings';
